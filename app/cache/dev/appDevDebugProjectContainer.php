...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'Z:/home/ts-montag.ru/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('Z:/home/ts-montag.ru/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', 'Z:/home/ts-montag.ru/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'Z:/home/ts-montag.ru/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'tsm', 'host' => 'localhost', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return EntityManager51324375cfea7_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager A EntityManager51324375cfea7_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager instance.
     */
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once 'Z:/home/ts-montag.ru/app/cache/dev/jms_diextra/doctrine/EntityManager_51324375cfea7.php';

        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_334fd94e6d1c69f82af9d3cd6d011b62');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_334fd94e6d1c69f82af9d3cd6d011b62');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_334fd94e6d1c69f82af9d3cd6d011b62');

        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => 'Z:\\home\\ts-montag.ru\\src\\Tsm\\CatalogBundle\\Entity')), 'Tsm\\CatalogBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('TsmCatalogBundle' => 'Tsm\\CatalogBundle\\Entity'));
        $e->setMetadataCacheImpl($a);
        $e->setQueryCacheImpl($b);
        $e->setResultCacheImpl($c);
        $e->setMetadataDriverImpl($d);
        $e->setProxyDir('Z:/home/ts-montag.ru/app/cache/dev/doctrine/orm/Proxies');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager51324375cfea7_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($f, $this);
    }
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'Z:/home/ts-montag.ru/app/Resources');
    }
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), '0ffd00a46f335515afa548f8fbf33c4b0a9278b1');
    }
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('Z:/home/ts-montag.ru/app/cache/dev/jms_diextra/metadata'));
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('Z:/home/ts-montag.ru/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:Z:/home/ts-montag.ru/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'Z:/home/ts-montag.ru/app/cache/dev/assetic/routing.yml', array('cache_dir' => 'Z:/home/ts-montag.ru/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appdevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appdevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context'), $this->get('monolog.logger.router'));
    }
    ...
    {
        return $this->services['sensio.distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('Z:/home/ts-montag.ru/app');
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('Z:/home/ts-montag.ru/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('Z:/home/ts-montag.ru/app/cache/dev/sessions');
    }
    ...
    protected function getSonata_Admin_PoolService()
    {
        ...
        $instance->setAdminServiceIds(array(0 => 'tsm.catalog.admin.catalog', 1 => 'tsm.catalog.admin.category'));
        $instance->setAdminGroups(array('Каталог' => array('label' => 'Каталог', 'label_catalogue' => 'SonataAdminBundle', 'items' => array(0 => 'tsm.catalog.admin.catalog', 1 => 'tsm.catalog.admin.category'))));
        $instance->setAdminClasses(array('Tsm\\CatalogBundle\\Entity\\Catalog' => 'tsm.catalog.admin.catalog', 'Tsm\\CatalogBundle\\Entity\\Category' => 'tsm.catalog.admin.category'));
    ...
    {
        return $this->services['sonata.admin.route_loader'] = new \Sonata\AdminBundle\Route\AdminPoolLoader($this->get('sonata.admin.pool'), array(0 => 'tsm.catalog.admin.catalog', 1 => 'tsm.catalog.admin.category'), $this);
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'Z:/home/ts-montag.ru/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => 'Z:/home/ts-montag.ru/app/cache/dev/translations', 'debug' => true));
    }

    /**
     * Gets the 'tsm.catalog.admin.catalog' service.
     *
     * @return Tsm\CatalogBundle\Admin\CatalogAdmin A Tsm\CatalogBundle\Admin\CatalogAdmin instance.
     */
    protected function getTsm_Catalog_Admin_CatalogService()
    {
        $instance = new \Tsm\CatalogBundle\Admin\CatalogAdmin('tsm.catalog.admin.catalog', 'Tsm\\CatalogBundle\\Entity\\Catalog', 'SonataAdminBundle:CRUD');
    ...
    /**
     * Gets the 'tsm.catalog.admin.category' service.
     *
     * @return Tsm\CatalogBundle\Admin\CategoryAdmin A Tsm\CatalogBundle\Admin\CategoryAdmin instance.
     */
    protected function getTsm_Catalog_Admin_CategoryService()
    {
        $instance = new \Tsm\CatalogBundle\Admin\CategoryAdmin('tsm.catalog.admin.category', 'Tsm\\CatalogBundle\\Entity\\Category', 'SonataAdminBundle:CRUD');
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'Symfony\\Bundle\\TwigBundle\\Controller\\ExceptionController::showAction', 'cache' => 'Z:/home/ts-montag.ru/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('Z:\\home\\ts-montag.ru\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
        $instance->addPath('Z:\\home\\ts-montag.ru\\vendor\\knplabs\\knp-menu\\src\\Knp\\Menu/Resources/views');
     ...
     *
     * @return EntityManager51324375cfea7_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager An instance of the doctrine.orm.default_entity_manager service
     */
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'Z:/home/ts-montag.ru/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('Z:/home/ts-montag.ru/app/cache/dev/assetic/assets');
    }
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        $a->setCacheDir('Z:/home/ts-montag.ru/app/cache/dev/jms_security/expressions');
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('Z:/home/ts-montag.ru/app/cache/dev/jms_security', true));
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'Z:/home/ts-montag.ru/app/cache/dev');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => 'Z:\\home\\ts-montag.ru\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'Z:/home/ts-montag.ru/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'Z:/home/ts-montag.ru/app/cache/dev',
            'kernel.logs_dir' => 'Z:/home/ts-montag.ru/app/logs',
            'kernel.bundles' => array(
                ...
                'TsmCatalogBundle' => 'Tsm\\CatalogBundle\\TsmCatalogBundle',
            ...
            'locale' => 'en',
            'secret' => '0ffd00a46f335515afa548f8fbf33c4b0a9278b1',
            'database_path' => NULL,
            ...
            'debug.container.dump' => 'Z:/home/ts-montag.ru/app/cache/dev/appDevDebugProjectContainer.xml',
            'debug.controller_resolver.class' => 'Symfony\\Bundle\\FrameworkBundle\\Controller\\TraceableControllerResolver',
            'kernel.secret' => '0ffd00a46f335515afa548f8fbf33c4b0a9278b1',
            ...
            'session.save_path' => 'Z:/home/ts-montag.ru/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => 'Z:\\home\\ts-montag.ru\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:Z:/home/ts-montag.ru/app/cache/dev/profiler',
            ...
            'router.resource' => 'Z:/home/ts-montag.ru/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'Z:/home/ts-montag.ru/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.memory.path' => 'Z:/home/ts-montag.ru/app/cache/dev/swiftmailer/spool',
            ...
            'assetic.cache_dir' => 'Z:/home/ts-montag.ru/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'Z:/home/ts-montag.ru/app/../web',
            'assetic.write_to' => 'Z:/home/ts-montag.ru/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'Z:/home/ts-montag.ru/app/cache/dev/doctrine/orm/Proxies',
            ...
            'jms_aop.cache_dir' => 'Z:/home/ts-montag.ru/app/cache/dev/jms_aop',
            ...
            'jms_di_extra.cache_dir' => 'Z:/home/ts-montag.ru/app/cache/dev/jms_diextra',
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.doctrine_integration.entity_manager.file' => 'Z:/home/ts-montag.ru/app/cache/dev/jms_diextra/doctrine/EntityManager_51324375cfea7.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager51324375cfea7_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'security.extra.cache_dir' => 'Z:/home/ts-montag.ru/app/cache/dev/jms_security',
